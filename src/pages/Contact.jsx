...
const Contact = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-gradient-to-br from-black via-gray-950 to-black text-white">
      <h1 className="text-5xl text-emerald-500 font-extrabold mb-10 drop-shadow-lg">Contact Me</h1>
      <div className="flex space-x-12 text-6xl">
        <a href="https://github.com/mranjaan" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-gray-300 transition-colors duration-300">
        ...
        <a href="mailto:bullzsocial@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email" className="hover:text-red-300 transition-colors duration-300">
          <svg className="w-16 h-16 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
          </svg>
        </a>
        <a href="https://www.linkedin.com/in/kishan-kumar-mranjaan/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-blue-300 transition-colors duration-300">
          <svg className="w-16 h-16 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://www.instagram.com/krishna__k_v/?igsh=MWR3ZHU0eDJzODVhMg%3D%3D#" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-pink-300 transition-colors duration-300">
          <svg className="w-16 h-16 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
